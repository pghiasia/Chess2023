...
// Everything beyond this point has been copied from the cs246 2023 fall Piazza post @2180.
...
void Xwindow::drawString(int x, int y, const string &msg, int colour, const string &fontName)
{
    XSetForeground(d, gc, colours[colour]);
    setUpFont(fontName);
